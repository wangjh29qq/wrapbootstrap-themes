...
$(".widget .widget-header > a[rel='control']").each(function(){var action_name=$(this).attr("action");switch(action_name){case "close":$(this).html("<i class='icon-remove'></i>");$(this).bind("click",function(){$(this).parent().parent().slideUp()});break;case "hide":$(this).html("<i class='icon-minus'></i>");$(this).bind("click",function(){$(this).parent().next("div").slideToggle();if($(this).html().trim().toLowerCase()=='<i class="icon-minus"></i>')$(this).html('<i class="icon-plus"></i>');else $(this).html('<i class="icon-minus"></i>')});
break;case "code":$(this).html("<i class='icon-legal'></i>");$(this).bind("click",function(){var html=$(this).parent().parent().parent().html().trim();html=html.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");var id=(new Date).getTime().toString();$('<div id="'+id+'" class="modal hide fade" tabindex="-1" role="dialog"><div class="modal-body"><pre class="prettyprint lang-html linenums"></pre></div></div>').appendTo("body");html=style_html(html,2," ",80);$("#"+id+" pre.prettyprint").html(html);
prettyPrint();$("#"+id).modal();$("#"+id).on("hidden",function(){$(this).remove()})});break;case "config":$(this).html('<i class="icon-cog"></i>');$(this).bind("click",function(){$("#"+$(this).attr("target-box")).modal()});break;case "help":$(this).html('<i class="icon-question-sign"></i>');$(this).bind("click",function(){$("#"+$(this).attr("target-box")).modal()});break;case "thumb":$(this).html('<i class="icon-arrow-left"></i>');$(this).bind("click",function(){add_to_sidebar($(this).parent().parent(),
$(this).parent().find("h3").html())});break;case "full":$(this).html('<i class="icon-fullscreen"></i>');$(this).bind("click",function(){var width=$(window).width();var height=$(window).height();if(!$(this).data("full")){$(this).data("position",$(this).parent().parent().css("position"));$(this).data("left",$(this).parent().parent().css("left"));$(this).data("top",$(this).parent().parent().css("top"));$(this).data("width",$(this).parent().parent().css("width"));$(this).data("height",$(this).parent().parent().css("height"));
$(this).data("background-color",$(this).parent().parent().css("background-color"));$(this).data("z-index",$(this).parent().parent().css("z-index"));$(this).parent().parent().fadeIn().css({"position":"absolute","left":"0px","top":"0px","width":width,"height":height,"background-color":"#272727","z-index":9999});$(this).data("full",true)}else{$(this).parent().parent().css({"position":$(this).data("position"),"left":$(this).data("left"),"top":$(this).data("top"),"width":$(this).data("width"),"height":$(this).data("height"),
"background-color":$(this).data("background-color"),"z-index":$(this).data("z-index")});$(this).data("full",false)}});break}});
...
$("#menuitem-filter").bind("keyup",function(e){var input=$("#menuitem-filter").val().trim().toLowerCase();if(e.keyCode==27){$("#menuitem-filter").val("");input=""}$(".icon-menu > ul > li:nth-child(n+4)").each(function(){if(input.length>0&&($(this).attr("keywords")||"").toLowerCase().indexOf(input)==-1&&($(this).find("a > span").html()||"").toLowerCase().indexOf(input)==-1)display="none";else display="block";$(this).css("display",display)})});var global_hover=null;
