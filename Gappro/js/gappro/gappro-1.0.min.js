...
$(this).bind("click",function(){add_to_sidebar($(this).parent().parent(),$(this).parent().find("h3").html())})}else $(this).remove();break;case "full":$(this).html('<i class="icon-fullscreen"></i>');$(this).bind("click",function(){var width=$(window).width();var height=$(window).height();if(!$(this).data("full")){$(this).data("position",$(this).parent().parent().css("position"));$(this).data("left",$(this).parent().parent().css("left"));$(this).data("top",$(this).parent().parent().css("top"));$(this).data("width",
$(this).parent().parent().css("width"));$(this).data("height",$(this).parent().parent().css("height"));$(this).data("background-color",$(this).parent().parent().css("background-color"));$(this).data("z-index",$(this).parent().parent().css("z-index"));$(this).parent().parent().fadeIn().css({"position":"absolute","left":"0px","top":"0px","width":width,"height":height,"background-color":"#272727","z-index":9999});$(this).data("full",true)}else{$(this).parent().parent().css({"position":$(this).data("position"),
"left":$(this).data("left"),"top":$(this).data("top"),"width":$(this).data("width"),"height":$(this).data("height"),"background-color":$(this).data("background-color"),"z-index":$(this).data("z-index")});$(this).data("full",false)}});break}});
